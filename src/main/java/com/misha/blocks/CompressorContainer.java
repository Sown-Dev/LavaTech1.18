...
public class CompressorContainer extends AbstractContainerMenu {
    ...
    public CompressorContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(Registration.COMPRESSOR_CONTAINER.get(), windowId);
        blockEntity = (CompressorBE) world.getBlockEntity(pos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, Registration.COMPRESSOR.get());
    }
