...
public class GardenScreen extends AbstractContainerScreen<GardenContainer> {
    private ResourceLocation GUI = new ResourceLocation(LavaPlus.MODID, "textures/gui/garden_gui.png");
    ...
    public GardenScreen(GardenContainer container, Inventory inv, Component name) {
    ...
    public void render(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if(mouseX>relX+8 && mouseX< relX+25 && mouseY>relY+6 && mouseY<relY+58){
            ...
            drawString(matrixStack, Minecraft.getInstance().font,   + menu.getEnergy()+"FE/"+GardenBE.capacity+"FE", mouseX+9, mouseY, 0xffffff);
            drawString(matrixStack, Minecraft.getInstance().font,   "Uses " + GardenBE.baseUsage+"FE/t", mouseX+9, mouseY+8, 0xffffff);
