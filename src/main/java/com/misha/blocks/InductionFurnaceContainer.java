...
InductionFurnaceBE blockEntity;
    ...
    public InductionFurnaceContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(Registration.INDUCTIONFURNACE_CONTAINER.get(), windowId);
        blockEntity = (InductionFurnaceBE) world.getBlockEntity(pos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, Registration.INDUCTIONFURNACE.get());
    }
