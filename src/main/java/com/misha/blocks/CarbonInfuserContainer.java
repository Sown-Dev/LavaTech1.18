...
public class CarbonInfuserContainer extends AbstractContainerMenu {

    CarbonInfuserBE blockEntity;
    ...
    public CarbonInfuserContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(Registration.CARBONINFUSER_CONTAINER.get(), windowId);
        blockEntity = (CarbonInfuserBE) world.getBlockEntity(pos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, Registration.CARBONINFUSER.get());
    }
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (index == 0) {
                ...
                if (CarbonInfuserBE.isValid(stack)) {
