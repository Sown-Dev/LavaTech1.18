...
public class IronDrillContainer extends AbstractContainerMenu {

    IronDrillBE blockEntity;
    ...
    public IronDrillContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(Registration.IRONDRILL_CONTAINER.get(), windowId);
        blockEntity = (IronDrillBE) world.getBlockEntity(pos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, Registration.IRONDRILL.get());
    }
