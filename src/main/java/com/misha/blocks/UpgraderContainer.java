...
public class UpgraderContainer extends AbstractContainerMenu {
    ...
    public UpgraderContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(Registration.UPGRADER_CONTAINER.get(), windowId);
        blockEntity = (UpgraderBE) world.getBlockEntity(pos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, Registration.UPGRADER.get());
    }
