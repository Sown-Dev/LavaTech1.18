...
public class FuelProcessorContainer extends AbstractContainerMenu {

    FuelProcessorBE blockEntity;
    ...
    public FuelProcessorContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(Registration.FUELPROCESSOR_CONTAINER.get(), windowId);
        blockEntity = (FuelProcessorBE) world.getBlockEntity(pos);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, Registration.FUELPROCESSOR.get());
    }
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (index == 0) {
                ...
                if (FuelProcessorBE.isValid(stack)) {
