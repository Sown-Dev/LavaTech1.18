...
public class CopperDrillScreen extends AbstractContainerScreen<CopperDrillContainer> {
    ...
    public CopperDrillScreen(CopperDrillContainer container, Inventory inv, Component name) {
    ...
    protected void renderBg(PoseStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        int cap = CopperDrillBE.capacity;
        int barX = relX+7;
