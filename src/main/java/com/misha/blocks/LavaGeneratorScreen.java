...
public class LavaGeneratorScreen extends AbstractContainerScreen<LavaGeneratorContainer> {
    ...
    protected void renderBg(PoseStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        int barX = relX+9;
        int barY = relY+58-(int)(((double)menu.getEnergy()/ (double)LavaGeneratorBE.capacity)*52);

        this.blit(matrixStack, barX,barY, 0, 0, 17, (int)(((double) menu.getEnergy()/ (double) LavaGeneratorBE.capacity)*52));
